...
void wall(double thickness)
{
	...
	GLfloat mat_diffuse[] = { 1.0f,1.0f,0.5f,1.0f };
	GLfloat mat_specular[] = { 0.5f,0.53,0.9f,1.0f };
...
void tableLeg(double thick, double len)
{
	...
	GLfloat mat_specular[] = { 0.1f,0.5f,0.9f,1.0f };
	GLfloat mat_shininess[] = { 50.0f };
...
{
	GLfloat mat_ambient[] = { 0.1f,0.2f,0.9f,1.0f };
	GLfloat mat_diffuse[] = { 0.5f,1.0f,0.5f,1.0f };
	GLfloat mat_specular[] = { 0.1f,0.5f,0.9f,1.0f };
	GLfloat mat_shininess[] = { 50.0f };
...
{
	GLfloat mat_ambient[] = { 1.0f,0.8f,0.5f,1.0f };
	GLfloat mat_diffuse[] = { 0.01f,0.5f,0.8f,1.0f };
	GLfloat mat_specular[] = { 0.1f,0.5f,0.9f,1.0f };
	GLfloat mat_shininess[] = { 50.0f };
